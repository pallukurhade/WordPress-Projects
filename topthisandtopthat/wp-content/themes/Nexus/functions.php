...
function et_nexus_add_customizer_css(){ ?>
	<style>
		...
		#top-menu li.current-menu-item > a, #top-menu > li > a:hover, .meta-info, .et-description .post-meta span, .categories-tabs:after, .home-tab-active, .home-tab-active:before, a.read-more, .comment-reply-link, h1.post-heading, .form-submit input, .home-tab-active:before, .et-recent-videos-wrap li:before, .nav li ul, .et_mobile_menu, #top-menu > .sfHover > a { background-color: <?php echo esc_html( et_get_option( 'accent_color', '#0069AA' ) ); ?>; }

		.featured-comments span, #author-info strong, #footer-bottom .current-menu-item a, .featured-comments span { color: <?php echo esc_html( et_get_option( 'accent_color', '#0069AA' ) ); ?>; }
		.entry-content blockquote, .widget li:before, .footer-widget li:before, .et-popular-mobile-arrow-next { border-left-color: <?php echo esc_html( et_get_option( 'accent_color', '#0069AA' ) ); ?>; }

		.et-popular-mobile-arrow-previous { border-right-color: <?php echo esc_html( et_get_option( 'accent_color', '#0069AA' ) ); ?>; }
