...
<?php if ( '' !== $thumb ) : ?>
	<div class="et-main-image">
		...
		<ul class="wwm_social_share wwm_bottom_right" style="display: block;"><li class="wwm_facebook"></li><li class="wwm_twitter"></li><li class="wwm_gplus"></li><li class="wwm_linked"></li></ul>	
		</a>
	</div>
<?php endif; ?>
